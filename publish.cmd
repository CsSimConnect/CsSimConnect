...
dotnet publish -o dist --force -c P3Dv4_Release -p:PublishReadyToRun=true --self-contained false -r win10-x64
cd CsSimConnectInterOp
msbuild CsSimConnectInterOp.vcxproj -property:Configuration=P3Dv4_Release
